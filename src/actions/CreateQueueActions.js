...
import { AVAILABLE_CHANGED, ROOM_CHANGED, QUEUE_CREATED, QUEUE_CREATED_FAILED, LOADING_BUTTON, STUD_SUBJECT, ALERT_MESSAGE } from './types';
...
//Getscalled when it tries to retrieve data but doesent fint it
  ...
  alertNotify(dispatch, 'Make sure you write the hourmark as 00:00.');
