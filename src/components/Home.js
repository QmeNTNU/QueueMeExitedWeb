      ...
      <div className="App">
        ...
        <div className="AppBlue">
          ...
          <img src={require('./images/divider.png')} className="info-image" alt="logo" />
              ...
              <div className="info">
                <div className="under-info"><img src={require('./images/webLock.png')} className="info-image2" alt="logo" /><div>1. Enter code</div></div>
                <div className="under-info"><img src={require('./images/webChooseassSubject.png')} className="info-image2" alt="logo" /><div>2. Choose subject</div></div>
                <div className="under-info"><img src={require('./images/webCreateQueue.png')} className="info-image2" alt="logo" /><div>3. Create Queue!</div></div>

              </div>
              <h2 style={{color: '#2c3e50'}}>Student</h2>

              <div className="info">
                <div className="under-info"><img src={require('./images/webChooseStudSubject.png')} className="info-image2" alt="logo" /><div>1. Choose Subject</div></div>
                <div className="under-info"><img src={require('./images/webchoose.png')} className="info-image2" alt="logo" /><div>2. Choose studass</div></div>
                <div className="under-info"><img src={require('./images/webInQueue.png')} className="info-image2" alt="logo" /><div>3. Join a queue!</div></div>
